...
# Define the custom optimizer class (replace CustomAdamOptimizer with your custom class name)
class CustomAdamOptimizer(tf.keras.optimizers.Adam):
    pass

# Register the custom optimizer with TensorFlow/Keras
...
def get_file_content_as_string(path):
    url='https://github.com/Asvitha-7/Emotion-recognition-main/blob/main/app.py' + path
